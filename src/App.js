...
import Option6 from './pages/Option6.js'
  ...
  return (
    ...
    <Routes location={location}>
         ...
         <Route path="/student-portal" element={
              ...
              <Route path="/student-portal/option1" element={<Option1 />} />
            <Route path="/student-portal/option2" element={<Option2 />} />
            <Route path="/student-portal/option3" element={<Option3 />} />
            <Route path="/student-portal/option4" element={<Option4 />} />
            <Route path="/student-portal/option5/:id" element={<Option5 />} />
            <Route path="/student-portal/option6" element={<Option6 />} />
            </Route>
